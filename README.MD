...
何为[AUTHKEY(Authorization Key)](https://github.com/BurpSuite/Manual/blob/master/Token.MD) [AUTHKEY (Authorization Key)](https://github.com/BurpSuite/Manual/blob/master/Token.MD)是如何运作的 
